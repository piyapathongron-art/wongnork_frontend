  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      if (isLogin && user?.id) {
        ...
        const joinedGroups = partiesList.filter(
          (p) =>
    ...
    <div className="fixed inset-0 bg-[#FDF2ED] dark:bg-black overflow-hidden flex flex-col font-sans">
      ...
      >
        <div className="flex flex-col gap-6 max-w-md mx-auto">
          ...
          <div
            key={`my-parties-container-${myParties.length}`}
      ...
      <CreatePartyModal
        ...
        onSuccess={loadData}
        initialRestaurant={location.state?.restaurantData}
      />
    </div>
  );
};
