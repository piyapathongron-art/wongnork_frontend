            ...
            <div className="bg-[#F7EAD7] dark:bg-zinc-900 w-full max-w-lg rounded-[40px] overflow-hidden shadow-2xl border border-[#BC6C25]/20 flex flex-col max-h-[92vh]">
                ...
                <div className="p-8 overflow-y-auto no-scrollbar pb-32">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 text-left">
                        {/* Location Dropdown */}
                        <div>
                            <label className="block text-[10px] font-black uppercase text-[#BC6C25] mb-1 ml-2">Meeting Point</label>
                            <select 
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {/* Max Participants */}
                            <div>
                                <label className="block text-[10px] font-black uppercase text-[#BC6C25] mb-1 ml-2">Max Slots</label>
                                <input 
                                    type="number"
                        ...
                        {/* Contact Info */}
                        <div>
                            <label className="block text-[10px] font-black uppercase text-[#BC6C25] mb-1 ml-2">Contact Info</label>
                            <input 
