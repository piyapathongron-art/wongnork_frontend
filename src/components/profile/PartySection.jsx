            ...
            <div className="flex gap-4 overflow-x-auto no-scrollbar pb-2">
                {activeParties.length === 0 ? (
                    ...
                    activeParties.map((party, index) => {
                        ...
                        return (
                            <div key={party.relationId || index} onClick={() => navigate(`/party/${party.id}/split-bill`)} className="flex-none w-[160px] bg-base-100 rounded-3xl p-3 shadow-sm border border-base-content/10 space-y-3 relative overflow-hidden cursor-pointer active:scale-95 transition-transform">
                                {party.isLeader && (
